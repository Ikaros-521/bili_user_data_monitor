...
使用说明：运行“双击运行.bat”，输入用户UID 回车，再输入循环周期 回车，即可开始监测。  
ps：数据存储是sqlite，可以使用**sqlitebrowser**来查看所有数据。  

# 效果图
![在这里插入图片描述](https://img-blog.csdnimg.cn/5a9f7eb5e38040a3aa97a98129d4ee69.gif#pic_center)
